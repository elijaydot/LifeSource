...
const Request = () => {
  ...
  return (
    <div className="p-4 md:p-10 space-y-6 font-work">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Request Tracking</h1>
          <p className="text-muted-foreground">
            Monitor and manage all blood and organ requests system-wide
          </p>
        </div>
        <Button className="bg-[#008080] hover:opacity-90">
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    <CardTitle className="text-lg flex items-center">
                      {request.id}
                      <Badge
                        className={`ml-3 ${getStatusColor(request.status)}`}
                      >
